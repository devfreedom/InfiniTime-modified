...
Notifications::NotificationItem::NotificationItem(const char* title,
  ...
  // MODIFIED: CHANGE CONTAINER BACKGROUND COLOR TO BLACK
  ...
  switch (category) {
    ...
    case Controllers::NotificationManager::Categories::IncomingCall: {
      ...
      // MODIFIED: CHANGE BUTTON BACKGROUND COLOR TO BLACK
      // lv_obj_set_style_local_bg_color(bt_accept, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::highlight);
      lv_obj_set_style_local_bg_color(bt_accept, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_BLACK);
      ...
      lv_obj_set_style_local_bg_color(bt_reject, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_BLACK);
      ...
      lv_obj_set_style_local_bg_color(bt_mute, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_BLACK); 
